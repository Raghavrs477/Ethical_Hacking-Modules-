...
def decrypt():
    ...
    if password == 2225:
        ...
        text2=Text(screen2,font="RPbote 10",fg="white",relief=GROOVE,wrap=WORD,bd=0)
...
def encrypt():
    ...
    if password == 2225:
        ...
        text2=Text(screen1,font="RPbote 10",fg="white",relief=GROOVE,wrap=WORD,bd=0)
        text2.place(x=10,y=40,width=380,height=150)
...
def main_screen():
    ...
    #icon
    image_icon=PhotoImage(file=r"D:\Projects\Ethical\keys.png")
